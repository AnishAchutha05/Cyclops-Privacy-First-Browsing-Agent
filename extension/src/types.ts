...
export interface PlanRequest { task:string; sanitized_context:string; available_tools:string[]; provider:string; model:string; api_key?:string; metadata?:Record<string,string>; }
